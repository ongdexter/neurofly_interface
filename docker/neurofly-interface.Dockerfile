...
RUN apt install -qy ros-noetic-eigen-conversions ros-noetic-tf ros-noetic-tf-conversions ros-noetic-xacro ros-noetic-robot-state-publisher ros-noetic-tf2-eigen ros-noetic-angles

# zed
RUN apt install -qy zstd ros-noetic-tf2-geometry-msgs ros-noetic-diagnostic-updater
RUN wget https://download.stereolabs.com/zedsdk/4.2/l4t35.4/jetsons && chmod +x jetsons && ./jetsons -- silent
...
#RUN --mount=type=ssh cd /root/catkin_ws/src && git clone git@github.com:ongdexter/quadrotor_ukf.git
